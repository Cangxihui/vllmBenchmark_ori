...
# file_path
folder_path = Path(r'C:\Users\Administrator.SY-202403121806\Desktop\result\qps')
result_dir = r'../result/'
## fix suffixed
suffixes = ["V1-FLASHMLA.json"]
...
labels = [label.replace("qps", "") for label in labels]
...
# **绘制折线图**
ax.plot(x_positions, output_throughput_values, linestyle="-", marker="o", markersize=8,
        color="black", markerfacecolor="red", markeredgecolor="black", linewidth=2)
...
# save figure
plt.tight_layout()
output_filename = result_dir + "V1-FLASHMLA-QPS_outthr.png"
...
# **绘制折线图**
ax2.plot(x_positions, mean_ttfts_value, linestyle="-", marker="o", markersize=8,
        color="black", markerfacecolor="red", markeredgecolor="black", linewidth=2)

ax2.set_xticks(x_positions)
ax2.set_xticklabels(labels, fontsize=12, ha="center")

ax2.set_xlabel("QPS", fontsize=16, fontweight="bold")
...
# save figure
plt.tight_layout()
output_filename2 = result_dir + "V1-FLASHMLA-QPS.png"
